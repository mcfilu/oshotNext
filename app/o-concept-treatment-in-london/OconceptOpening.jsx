  ...
  return (
    <div className={`flex w-full flex-row md:min-h-[55vh]  md:p-[2vh] md:pl-[0px]`}>
        <div className={`hidden md:flex w-[45%] h-[100%] flex items-center relative`}>
            ...
            <Image className={`w-screen h-screen object-cover`}  objectFit="cover" objectPosition="center" fill="true" src="/sherif_new.jpeg" alt=""></Image>
        </div>
        ...
        <div className={`flex w-full h-[30vh] relative`}>
                <Image  objectFit="cover" objectPosition="center" fill="true"  src="/sherif_new.jpeg" alt=""></Image>
            </div>
