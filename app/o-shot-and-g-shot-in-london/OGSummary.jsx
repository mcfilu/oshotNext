            ...
            <div className={` w-[100%] mx-auto h-[100%]`}>
                ...
                <div className={`flex flex-col md:flex-row justify-between px-[3vh] my-[5vh]`}>
                    <div className="inner-item flex flex-col items-center text-white">
                        ...
                        <h4 className="text-[2.5vh] font-medium mt-[1vh] font-main">45 to 60 mins</h4>
                    ...
                    <div className="inner-item flex flex-col items-center text-white mt-[5vh] md:mt-[0px]">
                        ...
                        {/* <span className="text-[2vh] font-light"></span> */}
                        <h4 className="text-[2.5vh] font-medium mt-[1vh] font-main">Local (numbing injection)</h4>
                ...
                <div>
                    ...
                    <div className={`flex flex-row`}>
                        ...
                        <p className="text-[2vh] font-light text-white w-[70%] font-main">Mild discomfort, tenderness and minor vaginal bleeding</p>
                    </div>
                    ...
                    <div className={`flex flex-row`}>
                        ...
                        Helps achieve enhanced sexual pleasure. Marked improvement in Lichen Sclerosus symptoms and enhanced sexual gratification and arousal
                        </p>
                    </div>
...
Return to normal immediately
                    ...
                    <div className={`flex flex-row`}>
                        ...
                        <p className="text-[2vh] font-light text-white w-[70%] font-main">
                        1 day, sexual intercourse could be resumed in one week
                        </p>
                    </div>
                    <hr className={`mt-[2vh] mb-4`}></hr>
                </div>
