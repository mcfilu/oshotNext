...
// import {  oshot_image4 } from '../assets'
...
const OshotImage = () => {
  return (
    <div className={`flex w-full h-screen relative`}>
        <Image className={`w-screen h-screen object-cover`} src={oshot_image4} objectFit="cover" objectPosition="center" fill="true" alt=""></Image>
        ...
        {/* <div className={`flex flex-col justify-center items-left h-screen w-[35%] ml-[3vh]`}> */}
                ...
                <h2 className={`text-gold1 text-[8vh] font-header mb-[1vh] text-left`}>And G-Shot</h2>
                        <h1 className={`text-white text-[2.2vh] md:text-[3vh] font-main mb-[1vh] text-left  w-full md:w-[65%]`}>Revitalize Your Intimacy: Discover the O Shot and G Shot Treatments in London</h1>
                        <a href="#og_opening" className={`text-gold1 hover-underline-animation2 text-left text-[2vh] font-main `}>READ MORE</a>
