  ...
  return (
    <div className={`flex w-full flex-row  md:min-h-[55vh]   `}>
        ...
        <div className={`hidden md:flex flex flex-col w-[55%] p-[2vh]  items-center`}>
            <h2 className={`text-gold1 text-[5vh] text-center font-header`}>G-Shot® Benefits</h2>
            <p className={`text-white font-poppins text-[2.1vh] text-justify mt-[3vh] mb-[2vh] font-main`}>The G-Shot®, also known as G-Spot Amplification, offers a remarkable solution for individuals seeking enhanced sexual pleasure and satisfaction. This innovative treatment targets the G-spot, a highly sensitive area inside the vagina, to unlock a range of benefits:</p>
