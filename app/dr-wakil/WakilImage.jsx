...
const WakilImage = () => {
  return (
    ...
    <Image className={`hidden md:flex w-screen h-screen object-cover`} src={sherif_bg } href="Dr Sherif Wakil opening image in his office in London" objectFit="cover" objectPosition="center" fill="true" ></Image>
    <Image className={`md:hidden w-screen h-screen object-cover`} src={sherif_bg_mobile } href="Dr Sherif Wakil opening image in his office in London" objectFit="cover" objectPosition="center" fill="true" ></Image>
