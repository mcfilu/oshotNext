...
const OshotImage = () => {
  return (
    <div className={`flex w-full h-screen relative`}>
        <Image objectFit="cover" objectPosition="center" fill="true" alt="" src={oshot_image1}  priority="true"></Image>
        ...
        {/* <div className={`flex flex-col justify-center items-left h-screen w-[35%] ml-[3vh]`}> */}
                    ...
                    <h2 className={`text-gold1 text-[8vh] font-header  mt-[3vh] text-left`}>O-Shot® UK</h2>
