    ...
    <div className={` flex w-full flex-row     `}>
        ...
        <div className={`hidden md:flex w-[55%] h-[100%]   flex flex-col items-left justify-between md:p-[2vh] pt-[0px] `}>
            <div className={`flex flex-col w-[100%]   items-center justify-center my-auto p-[1vh]`}>
                ...
                <p className={`flex text-white text-[2.2vh] mt-[1.5vh] font-main`}>Discover our O Shot® reviews and testimonials from real patient further down the page.</p>
        ...
        <div className={`flex flex-col md:hidden items-center`}>
            ...
            <div className={`flex w-full h-[35vh]`}>
                ...
                <p className={`flex text-white text-[2.2vh] mt-[1.5vh] ml-[1vh] font-main`}>Similar to the P-Shot®, the O-Shot® injection takes advantage of the body's innate healing capabilities to promote tissue growth and increase blood flow to the vagina, clitoris, and surrounding tissues. By triggering the activation of stem cells and promoting the regeneration of healthier tissue, our UK O Shot® aims to enhance and improve function and rejuvenate the overall sexual experience.</p>
                <p className={`flex text-white text-[2.2vh] mt-[1.5vh] ml-[1vh] font-main`}>Discover our O Shot® reviews and testimonials from real patient further down the page.</p>
                {/* <p className={`flex text-white text-[2.2vh] mt-[1.5vh] ml-[1vh] font-main`}>Named after the Greek god of fertility, the Priapus Shot®, or P-Shot®, is an innovative technique specifically designed to rejuvenate the penis, enhance sensation, and improve function. By utilizing Platelet Rich Plasma (PRP), this pioneering treatment offers a promising solution for individuals seeking to improve their sexual health and well-being.</p> */}
