            ...
            <div className={` p-[2vh]   `}>
                ...
                <div className={`flex flex-col md:ml-[5%]`} onClick={() => {setSecond(!openSecond)}}>
                    <div className={`flex flex-row justify-left`}>
                        ...
                        <h2 className={`${openSecond ? 'text-white' : 'text-white'} font-main text-[2.8vh]`}>Am I suitable for the O-Shot® injection treatment?</h2>
                    </div>
                    <div className={`flex flex-col ${openSecond ? '' : 'hidden'} md:w-[40vw] mt-[2vh] mb-[1vh] ml-[5%]`}>
                        ...
                        There are a number of sexual arousal disorders that the O-Shot® can be used to address. It is estimated that as many as 1 in 20 women suffer from Female Sexual Arousal Disorder, which means that, while they may want to have sex, they find it difficult to get aroused, experience pleasure or achieve orgasm.
                        </p>
                ...
                <div className={`flex flex-col md:ml-[5%]`} onClick={() => {setSixth(!openSixth)}}>
                    ...
                    <div className={`flex ${openSixth ? '' : 'hidden'} flex-col md:w-[40vw] mt-[2vh] mb-[1vh] ml-[5%]`}>
                        ...
                        <p className={`text-white text-[2.1vh] font-main`}>Please be advised that these results vary between patients according to age, medical condition, hormonal levels, social habits and the results are not guaranteed. Check out our O-Shot® reviews below to learn more about our results.</p>
                    </div>
                </div>
                <hr className={`border-gold1 mt-[1.4vh] mb-[1.4vh] w-[90%] mx-auto`}></hr>
            </div>
