...
//                     <div className={`w-full h-[50%] bg-white rounded-[9px]`}><Image src={erectile_dysfanction} className={`w-full h-full rounded-[9px]`} ></Image></div>
...
//                     <div className={`w-full h-[50%] bg-white rounded-[9px]`}><Image src={premature1} className={`w-full h-full rounded-[9px]`} ></Image></div>
...
//                     <div className={`w-full h-[50%] bg-white rounded-[9px]`}><Image src={incontinence} className={`w-full h-full rounded-[9px]`} ></Image></div>
...
<div className={`flex flex-col md:flex-row w-full items-center md:items-start justify-center mt-[2vh]  `}>
    ...
    <div  className={`relative flex flex-col       mt-[5vh] md:mt-[0px] hover:bg-opacity-80  hover:ease-in-out duration-500 items-center`}>
        ...
        <div className={`flex flex-col bg-black justify-center items-center`}>
            <div className={`flex h-[15vh] w-[25vw] md:w-[10vw] relative`}>
                <Image src={orgasm} className={`w-full h-full object-contain`} object-fit="cover" fill={true} href=""></Image>
            </div>
    ...
    <div  className={`relative flex flex-col      mt-[5vh] md:mt-[0px] hover:bg-opacity-80 ] hover:ease-in-out duration-500 mx-[10vw] items-center`}>
        ...
        <div className={`flex flex-col bg-black justify-center items-center`}>
            <div className={`flex h-[15vh]  w-[25vw] md:w-[10vw] relative`}>
                <Image src={ejaculation} className={`w-full h-full object-contain`} object-fit="cover" fill={true} href=""></Image>
            </div>
    ...
    <div  className={`relative flex flex-col     mt-[5vh] md:mt-[0px] hover:bg-opacity-80  hover:ease-in-out duration-500 items-center`}>
        ...
        <div className={`flex flex-col bg-black justify-center items-center`}>
            <div className={`flex h-[15vh]  w-[25vw] md:w-[10vw] relative`}>
                <Image src={libido} className={`w-full h-full object-contain`} object-fit="cover" fill={true} href=""></Image>
            </div>
