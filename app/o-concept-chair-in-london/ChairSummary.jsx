            ...
            <div className={` w-[100%] mx-auto h-[100%]`}>
                ...
                <div className={`flex flex-col md:flex-row justify-between px-[3vh] my-[5vh]`}>
                    <div className="inner-item flex flex-col items-center text-white">
                        ...
                        <h4 className="text-[2.5vh] font-medium mt-[1vh] font-main">30 mins</h4>
                    ...
                    <div className="inner-item flex flex-col items-center text-white mt-[5vh] md:mt-[0px]">
                        ...
                        <h4 className="text-[2.5vh] font-medium mt-[1vh] font-main">12 sessions on average</h4>
...
Increased bladder control. You may also see improvement in your orgasms, reduced pelvic pain.
                        </p>
                    </div>
...
Most studies suggest 6-12 months, however this varies amongst patient.
                        </p>
                    </div>
                    <hr className={`mt-[2vh] mb-4`}></hr>
                    <div className={`flex flex-row`}>
...
Immediately
                    ...
                    <hr className={`mt-[2vh] mb-4`}></hr>
                    <div className={`flex flex-row`}>
                        <span className="text-[2vh] font-medium w-[30%] text-gold1 font-main">Technology and products used:</span>
                        <p className="text-[2vh] font-light text-white w-[70%] font-main">
