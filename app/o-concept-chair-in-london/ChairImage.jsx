...
const OshotImage = () => {
  return (
    <div className={`flex w-full h-screen relative`}>
        <Image className={`w-screen h-screen object-cover`} src={oshot_image6} objectFit="cover" objectPosition="center" fill="true" alt=""></Image>
        ...
        {/* <div className={`flex flex-col justify-center items-left h-screen w-[35%] ml-[3vh]`}> */}
                    ...
                    <h2 className={`text-gold1 text-[8vh] font-header  mt-[3vh] text-left`}>O-Concept Chair </h2>
                <h2 className={`text-gold1 text-[8vh] font-header mb-[1vh] text-left`}>For Her</h2>
                        <h1 className={`text-white text-[2.2vh] md:text-[3vh] font-main mb-[1vh] text-left  w-full md:w-[65%]`}>Experience Elevated Comfort: Introducing the O Concept Chair in London</h1>
