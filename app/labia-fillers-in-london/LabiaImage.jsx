...
const OshotImage = () => {
  return (
    <div className={`flex w-full h-screen relative`}>
        <Image className={`w-screen h-screen object-cover`} src={oshot1} objectFit="cover" objectPosition="center" fill="true" alt=""></Image>
        ...
        {/* <div className={`flex flex-col justify-center items-left h-screen w-[35%] ml-[3vh]`}> */}
                    ...
                    <h2 className={`text-gold1 text-[8vh] font-header  mt-[3vh] text-left`}>Labia </h2>
                <h2 className={`text-gold1 text-[8vh] font-header mb-[1vh] text-left`}>Fillers</h2>
                        <h1 className={`text-white text-[2.2vh] md:text-[3vh] font-main mb-[1vh] text-left  w-full md:w-[65%]`}>Enhance Your Confidence with Safe and Natural-Looking Labia Fillers in London</h1>
