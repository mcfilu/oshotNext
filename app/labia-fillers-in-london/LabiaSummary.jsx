            ...
            <div className={` w-[100%] mx-auto h-[100%]`}>
                ...
                <div className={`flex flex-col md:flex-row justify-between px-[3vh] my-[5vh]`}>
                    <div className="inner-item flex flex-col items-center text-white">
                        ...
                        <h4 className="text-[2.5vh] font-medium mt-[1vh] font-main md:max-w-[25vw] text-center">Approx. 30-45 mins, injection time 15 mins.</h4>
                    ...
                    <div className="inner-item flex flex-col items-center text-white mt-[5vh] md:mt-[0px]">
                        ...
                        <h4 className="text-[2.5vh] font-medium mt-[1vh] font-main md:max-w-[25vw] text-center">One and it could be topped up/repeated whenever patients feels like it.</h4>
                    ...
                    <div className="inner-item flex flex-col items-center text-white mt-[5vh] md:mt-[0px]">
                        ...
                        {/* <span className="text-[2vh] font-light"></span> */}
                        <h4 className="text-[2.5vh] font-medium mt-[1vh] font-main md:max-w-[25vw] text-center">Topical (numbing cream)/ local</h4>
                ...
                <div>
                    ...
                    <div className={`flex flex-row`}>
                        ...
                        <p className="text-[2vh] font-light text-white w-[70%] font-main">Mild Swelling, redness, tenderness.</p>
                    </div>
...
Visible immediately post-treatment
                        </p>
                    </div>
                    ...
                    <div className={`flex flex-row`}>
                        ...
                        <p className="text-[2vh] font-light text-white w-[70%] font-main">
                        Up to 15-18 months for some. Repeat treatments after a year is recommeneded
                        </p>
                    </div>
                    <hr className={`mt-[2vh] mb-4`}></hr>
                    <div className={`flex flex-row`}>
...
Immediately, although you might feel mild discomfort
                        </p>
                    </div>
                    <hr className={`mt-[2vh] mb-4`}></hr>
                    <div className={`flex flex-row`}>
...
A few days, refrain from sexual intercourse for few days to avoid flattening of the filler
                        </p>
                    </div>
                    <hr className={`mt-[2vh] mb-4`}></hr>
                </div>
            ...
            <div  className={`md:absolute bg-gold1 bg-opacity-100  ease-in-out duration-500 bg-opacity-100 top-[22%] -right-[17.5vw] md:w-[24vw]   p-[2vh] mt-[5vh] md:mt-[0px] bg-opacity-100 shadow-[0px_0px_20px_2px_#ad9444] ease-in-out duration-500`}>
                    ...
                    <h1 className={`font-main text-black font-bold text-[5.5vh] `}>£ 450</h1>
