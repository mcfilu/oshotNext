            ...
            <div className={` w-[100%] mx-auto h-[100%]`}>
                ...
                <div className={`flex flex-col md:flex-row justify-between px-[3vh] my-[5vh]`}>
                    <div className="inner-item flex flex-col items-center text-white">
                        ...
                        <h4 className="text-[2.5vh] font-medium mt-[1vh] font-main">Approx. 15 mins</h4>
                    ...
                    <div className="inner-item flex flex-col items-center text-white mt-[5vh] md:mt-[0px]">
                        ...
                        <h4 className="text-[2.5vh] font-medium mt-[1vh] font-main">One-Four</h4>
                ...
                <div>
                    ...
                    <div className={`flex flex-row`}>
                        ...
                        Enhanced vaginal comfort and increased blood flow to the pelvic region, contributing to the restoration of a woman's libido and boosting self-confidence.
                        </p>
                    </div>
                    ...
                    <div className={`flex flex-row`}>
                        ...
                        <p className="text-[2vh] font-light text-white w-[70%] font-main">
                        Varies, a touch-up treatment session within 12 months may be recommended
                        </p>
                    </div>
                    <hr className={`mt-[2vh] mb-4`}></hr>
                    <div className={`flex flex-row`}>
                    ...
                    <div className={`flex flex-row`}>
                        ...
                        <p className="text-[2vh] font-light text-white w-[70%] font-main">
                        Return to normal immediately, patients should refrain from sexual activity for 7 days
                        </p>
                    </div>
                    <hr className={`mt-[2vh] mb-4`}></hr>
                </div>
